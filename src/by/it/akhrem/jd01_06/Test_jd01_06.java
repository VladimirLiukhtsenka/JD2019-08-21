...
public class Test_jd01_06 {
    ...
    public void testTaskC2() throws Exception {
        ...
        String s1 = (String) mSlow.invoke(null, by.it.akhrem.jd01_06.Poem.text);
        long dtSlow = (System.nanoTime() - t) / 1000;
        System.out.println("slow dt=" + dtSlow);

        t = System.nanoTime();
        String s2 = (String) mFast.invoke(null, by.it.akhrem.jd01_06.Poem.text);
        ...
        String[] word = by.it.akhrem.jd01_06.Poem.text.split("[^а-яА-ЯёЁ]+");
        for (int i = 0; i < 10; i++) {
