package by.it.daletski.jd01_15;
...
public class TaskB {
    public static void main(String[] args) {
        String filename = getPath(TaskB.class) + TaskB.class.getSimpleName() + ".java"; // первый комментарий
        String wrFilename = getPath(TaskB.class) + TaskB.class.getSimpleName() + ".txt";
        System.out.println(filename);//второй комментарий
        StringBuilder sb = new StringBuilder();
        try (BufferedReader bf = new BufferedReader(new FileReader(filename)); //Исключения
